...
namespace BookingService.Controllers
{
    ...
    public class BookingController : ControllerBase
    {
        ...
        [HttpGet("historyall/{UserId}")]
        public IActionResult GetAllBookingHistory(int UserId)
        {
            try
            {
                IEnumerable<TblUserMaster> userMaster = _dbContext.TblUserMasters.ToList();
                IEnumerable<TblBookingDetail> bookingDetails = _dbContext.TblBookingDetails.ToList().Where(m => m.UserId == UserId);
